...
public class PerformanceTestResult implements Serializable {
	...
	static {
		...
		map.put("tps", Double.class);
		map.put("responseTime", Double.class);
		map.put("pressCpu", Double.class);
		map.put("pressMemory", Double.class);
		map.put("everyTimeDetails", Integer.class);
	}
