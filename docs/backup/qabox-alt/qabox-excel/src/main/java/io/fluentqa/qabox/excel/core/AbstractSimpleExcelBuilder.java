...
import io.fluentqa.qabox.excel.core.annotation.ExcludeColumn;
import io.fluentqa.qabox.excel.core.annotation.IgnoreColumn;
...
import io.fluentqa.qabox.excel.core.parser.StyleParser;
import io.fluentqa.qabox.excel.core.parser.Table;
...
abstract class AbstractSimpleExcelBuilder {
    ...
    private void setTdContent(Td td, Pair<? extends Class, ?> pair) {
        ...
        } else if (io.fluentqa.qabox.excel.core.constant.File.class.isAssignableFrom(fieldType)) {
