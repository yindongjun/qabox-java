...
import io.fluentqa.alt.proxyee.crt.CertPool;
...
import io.fluentqa.alt.proxyee.proxy.ProxyConfig;
import io.fluentqa.alt.proxyee.proxy.ProxyHandleFactory;
import io.fluentqa.alt.proxyee.server.HttpProxyServer;
import io.fluentqa.alt.proxyee.server.HttpProxyServerConfig;
import io.fluentqa.alt.proxyee.server.auth.HttpAuthContext;
import io.fluentqa.alt.proxyee.server.auth.HttpProxyAuthenticationProvider;
...
public class HttpProxyServerHandler extends ChannelInboundHandlerAdapter {
    ...
    private void handleProxyData(Channel channel, Object msg, boolean isHttp) throws Exception {
        ...
        ProtoUtil.RequestProto pipeRp = getInterceptPipeline().getRequestProto();
        boolean isChangeRp = false;
        if (isHttp && msg instanceof HttpRequest) {
            HttpRequest httpRequest = (HttpRequest) msg;
            // 检查requestProto是否有修改
            ProtoUtil.RequestProto newRP = ProtoUtil.getRequestProto(httpRequest);
