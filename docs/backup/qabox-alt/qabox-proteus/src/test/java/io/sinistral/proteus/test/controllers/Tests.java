...
public class Tests
{
	...
	@Produces(MediaType.APPLICATION_JSON)
	@Blocking
	public ServerResponse<Map<String,Object>> multipartUploadMixedWithFile(ServerRequest request, @FormParam("file") File file, @FormParam("user") User user, @FormParam("userId") Integer userId ) throws Exception
	{
	...
	@Produces(MediaType.APPLICATION_JSON)
	@Blocking
	public CompletableFuture<ServerResponse<Map<String,Object>>> multipartUploadFutureMixedWithFile(ServerRequest request, @FormParam("file") File file, @FormParam("user") User user, @FormParam("userId") Integer userId ) throws Exception
	{
