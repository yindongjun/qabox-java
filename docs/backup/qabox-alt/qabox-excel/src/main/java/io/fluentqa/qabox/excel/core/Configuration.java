...
public class Configuration {
    ...
    /**
     * 是否导出所有字段，否，则只导出含{@link io.fluentqa.qabox.excel.core.annotation.ExcelColumn}注解字段
     */
    ...
    /**
     * 是否使用字段名称作为标题，当{@link io.fluentqa.qabox.excel.core.annotation.ExcelColumn}设定了title，则覆盖
     */
