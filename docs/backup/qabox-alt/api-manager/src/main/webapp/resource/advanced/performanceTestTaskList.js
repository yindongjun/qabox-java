		...
		".view-test":function(){
			...
			$.post(REQUEST_URL.PERFORMANCE_TEST.TASK_VIEW, {objectId:data.objectId}, function(text){
				if (text.returnCode == 0) {	
					parent.layer_show("性能测试视图", templates["performance-test-task-view"](text.data), null, null, 1, function(layero, index){
						window.intervalId = parent.createTestView(layero, text.data);
					}, null, function(){
