...
public class InterfaceInfo implements Serializable,Cloneable {
    ...
    public void setUpdateParam(Parameter updateParam) {
        this.updateParam = updateParam;
    }

    @JSON(serialize = false)
    public Parameter getUpdateParam() {
        return updateParam;
    }
	...
	@Override
	protected InterfaceInfo clone() throws CloneNotSupportedException {
		InterfaceInfo interfaceInfo = new InterfaceInfo();
		interfaceInfo.setInterfaceCnName(this.interfaceCnName);
		interfaceInfo.setCreateTime(new Timestamp(System.currentTimeMillis()));
		interfaceInfo.setInterfaceName(this.interfaceName);
		interfaceInfo.setInterfaceProtocol(this.interfaceProtocol);
		interfaceInfo.setInterfaceType(this.interfaceType);
		interfaceInfo.setMark(this.mark);
		interfaceInfo.setParameters(this.parameters);
		interfaceInfo.setStatus(this.status);
		interfaceInfo.setUser(FrameworkUtil.getLoginUser());
		interfaceInfo.setSystems(this.systems);
		interfaceInfo.setRequestUrlReal(this.requestUrlReal);
		interfaceInfo.setLastModifyUser(FrameworkUtil.getLoginUser().getRealName());
