...
import io.fluentqa.qabox.excel.core.parser.ContentTypeEnum;
import io.fluentqa.qabox.excel.core.parser.HtmlTableParser;
import io.fluentqa.qabox.excel.core.parser.Td;
import io.fluentqa.qabox.excel.core.parser.Tr;
import io.fluentqa.qabox.excel.core.strategy.SheetStrategy;
import io.fluentqa.qabox.excel.core.strategy.WidthStrategy;
import io.fluentqa.qabox.excel.core.style.BackgroundStyle;
import io.fluentqa.qabox.excel.core.style.BorderStyle;
import io.fluentqa.qabox.excel.core.style.CustomColor;
import io.fluentqa.qabox.excel.core.style.FontStyle;
import io.fluentqa.qabox.excel.core.style.LinkDefaultCellStyle;
import io.fluentqa.qabox.excel.core.style.TdDefaultCellStyle;
import io.fluentqa.qabox.excel.core.style.TextAlignStyle;
import io.fluentqa.qabox.excel.core.style.ThDefaultCellStyle;
import io.fluentqa.qabox.excel.core.style.WordBreakStyle;
import io.fluentqa.qabox.excel.exception.ExcelBuildException;
import io.fluentqa.qabox.excel.exception.SaxReadException;
import io.fluentqa.qabox.excel.utils.ColorUtil;
...
public abstract class AbstractExcelFactory implements ExcelFactory {
    ...
    private void doSetInnerSpan(Cell cell, Td td) {
        ...
        for (io.fluentqa.qabox.excel.core.parser.Font font : td.fonts) {
