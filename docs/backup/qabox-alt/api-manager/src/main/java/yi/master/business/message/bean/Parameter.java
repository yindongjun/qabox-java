...
public class Parameter implements Serializable,Cloneable {
    ...
    public Parameter clone() {
        ...
        parameter.setAttributes(this.attributes);
        parameter.setPath(this.path);
        parameter.setType(this.type);
        parameter.setDefaultValue(this.defaultValue);
        parameter.setMark(this.mark);
        parameter.setParameterIdentify(this.parameterIdentify);
        parameter.setParameterName(this.parameterName);
