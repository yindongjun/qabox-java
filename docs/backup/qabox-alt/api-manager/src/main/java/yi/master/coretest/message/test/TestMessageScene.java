...
public class TestMessageScene implements Cloneable {
    ...
    /**
     * 使用数据池类别:可以包含全局变量，全局变量要在使用之前先处理
     */
    private Map<String, String> poolData;
    /**
     * 当前数据池poolDataItemId,只有设置了该值才会启用数据池
     */
    private Integer poolDataItemId;

	/**
	 * body转query
	 */
	private boolean bodyToQuery;
	...
	public boolean isBodyToQuery() {
		return bodyToQuery;
	}

	public void setBodyToQuery(boolean bodyToQuery) {
		this.bodyToQuery = bodyToQuery;
	}

	public void setPoolDataItemId(Integer poolDataItemId) {
        this.poolDataItemId = poolDataItemId;
    }

    public Integer getPoolDataItemId() {
        return poolDataItemId;
    }
    ...
    public void setPoolData(Map<String, String> poolData) {
