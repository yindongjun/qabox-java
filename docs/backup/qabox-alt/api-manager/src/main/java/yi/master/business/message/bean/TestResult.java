...
public class TestResult implements Serializable, Comparable<TestResult> {
    ...
    public String getPoolItemName() {
        return (this.poolDataItem == null || this.poolDataItem.getDataPool() == null) ? "" : this.poolDataItem.getName();
    }

    public String getPoolName() {
        return (this.poolDataItem == null || this.poolDataItem.getDataPool() == null)  ? "" : this.poolDataItem.getDataPool().getName();
    }
