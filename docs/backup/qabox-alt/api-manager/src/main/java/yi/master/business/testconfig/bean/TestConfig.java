...
public class TestConfig implements Serializable, Cloneable {
     ...
     * 所用数据池类别
     */
	private List<PoolDataItem> poolDataItems;
    ...
    public List<PoolDataItem> getPoolDataItems() {
        return PracticalUtils.getPoolDataItems(this.poolItemIds);
    }
    ...
    public void setPoolItemIds(String poolItemIds) {
        this.poolItemIds = poolItemIds;
    }

    public String getPoolItemIds() {
        return poolItemIds;
    }
